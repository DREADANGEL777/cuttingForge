/* Translations for the static landing page.
   Mirrors the content structure of the original React app (src/i18n/ua.js, en.js). */
const translations = {
  ua: {
    seo: {
    ...
    hero: {
      ...
      stat1value: "0.1 мм",
      stat1: "Точність різання",
      stat2value: "1-3 дні",
      stat2: "Термін виконання",
      stat3value: "1000+",
      stat3: "Деталей на день",
    },
    about: {
      badge: "Про нас",
    ...
    services: {
      ...
      item2f2: "Пази та отвори",
      item2f3: "Індивідуальні деталі",
      item2f4: "Повторне виробництво",
    },
    products: {
      badge: "Що ми виготовляємо",
      title: "Вироби з фанери під ваші задачі",
      description:
    ...
    gallery: {
      ...
      items: [
        ...
        { title: "Меблевий елемент", category: "Меблі" },
        { title: "Навчальний конструктор", category: "Моделі" },
        { title: "Корпоративний сувенір", category: "Сувеніри" },
        { title: "Індивідуальна деталь", category: "CNC" },
      ],
    },
    process: {
      badge: "Процес роботи",
    ...
    contact: {
      ...
      uploadTitle: "Перетягніть файли сюди",
      uploadSubtitle: "або натисніть для вибору",
      maxFiles: "Максимум 5 файлів",
      maxSize: "До 20 MB кожен",
      ...
      errors: {
        requiredName: "Вкажіть ваше ім'я.",
        requiredContact: "Вкажіть телефон або Email.",
        invalidContact: "Некоректний телефон або Email.",
        requiredMessage: "Опишіть ваше замовлення.",
        tooManyFiles: "Можна прикріпити максимум 5 файлів.",
        fileTooLarge: "Файл перевищує 20 MB.",
        invalidFormat: "Непідтримуваний формат файлу.",
        duplicateFile: "Такий файл уже додано.",
      },
    },
    footer: {
